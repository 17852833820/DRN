...
def main():
    ...
    # _ret, prev = cam.read()
    prev = cv.imread("../drn/datasets/cityscapes/leftImg8bit/demoVideo/stuttgart_00/stuttgart_00_000000_000001_leftImg8bit.png")
    ...
    img = cv.imread("../drn/datasets/cityscapes/leftImg8bit/demoVideo/stuttgart_00/stuttgart_00_000000_000002_leftImg8bit.png")
