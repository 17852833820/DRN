...
def pixelAccuracy(imPred, imLab):
    """
    This function takes the prediction and labels of a single image, returns pixel-wise accuracy
...
def intersectionAndUnion(imPred, imLab, numClass):
    """
    This function takes the prediction and labels of a single image,
