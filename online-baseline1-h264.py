    ...
    for iter, (image, label, name) in enumerate(eval_data_loader):
        ...
        if prev_gray is not None :
            if  iter_fps<(upload_fps)<(iter_fps+(1/17.0)) or iter%17==0 or fps==17:
                ...
                upload_num += 1
                # if fps==17:
                save_output_images(pred, name, output_dir='/media/xxd/新加卷/Projects/DRN/run_log/pred_img/youtube_drn38_4gLTE/baseline1/')
                ...
                pred = load_label('/media/xxd/新加卷/Projects/DRN/run_log/pred_img/youtube_drn38_4gLTE/baseline1/'+ '/' + name[0].split("/")[-1])
                # else:
               ...
               save_output_images(pred, name, output_dir='/media/xxd/新加卷/Projects/DRN/run_log/pred_img/youtube_drn38_4gLTE/baseline1/')
               preda = load_label('/media/xxd/新加卷/Projects/DRN/run_log/pred_img/youtube_drn38_4gLTE/baseline1/'+ '/' + name[0].split("/")[-1])
